...
checkpoint='https://download.openmmlab.com/mmclassification/v0/convnext-v2/convnext-v2-large_3rdparty-fcmae_in1k_20230104-bf38df92.pth'
model = dict(
    type='Mask2Former',
...
vis_backends = [dict(type='LocalVisBackend'), 
                dict(type='WandbVisBackend',
                     init_kwargs=dict(
                         project='PureSeg',
                         name=\
    f'mask2former_convnextv2-large_lr={start_lr}_nwpu_{max_epochs}e',
                         tags=['nwpu', 'mask2former', 'ConvNeXtV2', 'large'],
                         group='mask2former',
                        #  resume=True
        )
    )
