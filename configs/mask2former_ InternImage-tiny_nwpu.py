...
checkpoint_file = 'https://download.openmmlab.com/mmpretrain/v1.0/dinov2/vit-base-p14_dinov2-pre_3rdparty_20230426-ba246503.pth'  # noqa
model = dict(
    type='Mask2Former',
...
vis_backends = [dict(type='LocalVisBackend'), 
                dict(type='WandbVisBackend',
                     init_kwargs=dict(
                         project='pure-seg',
                         name=\
    f'mask2former_internimage_lr={start_lr}_nwpu_{max_epochs}e',
                         group='mask2former',
                         resume=True
        )
    )
