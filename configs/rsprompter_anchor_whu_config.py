...
param_scheduler_callback = dict(
    type='ParamSchedulerHook' #! 这里不能换成ParamSchedulerHook
)
...
val_loader = dict(
        ...
        dataset=dict(
            ...
            ann_file='/nfs/home/3002_hehui/xmx/data/WHU/annotations/WHU_building_test.json',
            # data_prefix=dict(img_path=val_data_prefix + '/image'),
            data_prefix=dict(img=val_data_prefix + '/image'),
            test_mode=True,
...
datamodule_cfg = dict(
    ...
    train_loader=dict(
        ...
        dataset=dict(
            ...
            # data_prefix=dict(img_path='imgs'),
            ann_file='/nfs/home/3002_hehui/xmx/data/WHU/annotations/WHU_building_train.json',
            # data_prefix=dict(img_path=train_data_prefix + '/image'),
            data_prefix=dict(img=train_data_prefix + '/image'),
            filter_cfg=dict(filter_empty_gt=True, min_size=32),
