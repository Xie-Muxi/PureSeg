...
data_parent = '/nfs/home/3002_hehui/xmx/data/WHU/'
...
datamodule_cfg = dict(
    predict_loader=dict(
        ...
        dataset=dict(
            ann_file=
            '/nfs/home/3002_hehui/xmx/data/WHU/annotations/WHU_building_test.json',
            backend_args=None,
            data_prefix=dict(img='test//image'),
            data_root='/nfs/home/3002_hehui/xmx/data/WHU/',
    ...
    train_loader=dict(
        ...
        dataset=dict(
            ann_file=
            '/nfs/home/3002_hehui/xmx/data/WHU/annotations/WHU_building_train.json',
            backend_args=None,
...
evaluator_ = dict(
    ...
    type='mmpl.evaluation.metrics.CocoPLMetric')
exp_name = 'sam-anchor-E20230720_01'
image_size = (
    1024,
    1024,
)
        ...
        roi_head=dict(
            ...
            mask_head=dict(
                ...
                loss_mask=dict(
                    ...
                    use_mask=True),
                per_query_point=4,
                type='mmpl.models.SAMPromptMaskHead',
                with_sincos=True),
...
trainer_cfg = dict(
    ...
    default_root_dir='results/dev/sam-anchor-E20230720_01',
    devices=1,
