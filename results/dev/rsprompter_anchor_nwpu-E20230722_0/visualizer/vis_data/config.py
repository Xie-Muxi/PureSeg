...
callbacks = [
    ...
    dict(
        dirpath='results/dev/rsprompter_anchor_nwpu-E20230722_0/checkpoints',
...
datamodule_cfg = dict(
    predict_loader=dict(
        ...
        dataset=dict(
            ann_file=
            '/nfs/home/3002_hehui/xmx/RS-SA/RSPrompter/data/NWPU/annotations/NWPU_instances_val.json',
            backend_args=None,
...
logger = dict(
    group='sam-anchor',
    name='rsprompter_anchor_nwpu-E20230722_0',
    project='dev',
    type='WandbLogger')
max_epochs = 100
model_cfg = dict(
...
param_scheduler = [
    dict(
        ...
        start_factor=0.0001,
        type='LinearLR'),
    dict(T_max=100, begin=1, by_epoch=True, end=100, type='CosineAnnealingLR'),
]
...
trainer_cfg = dict(
    ...
    callbacks=[
        ...
        dict(
            dirpath=
            'results/dev/rsprompter_anchor_nwpu-E20230722_0/checkpoints',
            filename='epoch_{epoch}-map_{valsegm_map_0:.4f}',
            mode='max',
            monitor='valsegm_map_0',
            save_last=True,
    ...
    default_root_dir='results/dev/rsprompter_anchor_nwpu-E20230722_0',
    devices=4,
    log_every_n_steps=5,
    logger=dict(
        group='sam-anchor',
