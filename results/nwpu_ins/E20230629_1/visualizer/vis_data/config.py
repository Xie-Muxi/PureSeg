...
callbacks = [
    ...
    dict(
        dirpath='results/nwpu_ins/E20230629_1/checkpoints',
...
datamodule_cfg = dict(
    ...
    train_loader=dict(
        ...
        dataset=dict(
            ann_file=
            '/nfs/home/3002_hehui/xmx/data/NWPU/NWPU VHR-10 dataset/nwpu-instances_train.json',
            backend_args=None,
            data_prefix=dict(img_path='positive image set'),
            data_root='/nfs/home/3002_hehui/xmx/data/NWPU/NWPU VHR-10 dataset/',
            filter_cfg=dict(filter_empty_gt=True, min_size=32),
...
param_scheduler = [
    dict(
        ...
        type='LinearLR'),
    dict(
        T_max=1200, begin=1, by_epoch=True, end=1200,
        type='CosineAnnealingLR'),
]
...
trainer_cfg = dict(
    ...
    default_root_dir='results/nwpu_ins/E20230629_1',
    devices=4,
    log_every_n_steps=5,
    logger=dict(
        group='sam-anchor',
